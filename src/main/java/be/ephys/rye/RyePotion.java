...
public class RyePotion extends Potion {
  ...
  public RyePotion(String name, boolean badEffect, int color, int iconIndexX, int iconIndexY) {
    super(badEffect, color);

    this.iconX = iconIndexX;
    this.iconY = iconIndexY;

    setPotionName("effect." + RyeMod.MODID + ":" + name + ".name");
  ...
  public void renderHUDEffect(@Nonnull PotionEffect effect, Gui gui, int x, int y, float z, float alpha) {
    ...
    gui.drawTexturedModalRect(x + 3, y + 3, iconX * 18, iconY * 18, 18, 18);
